...
KRITICKÉ PRAVIDLÁ pre JSON:
- Všetky polia vyplň SKUTOČNÝMI hodnotami — NIKDY nedávaj "{{Z2_MENO}}" ani "XXXX" ako hodnotu
- Ak sú 2 záujemcovia: Z2_* polia vyplň skutočnými údajmi Z2 + pridaj 2. GDPR objekt s hodnotami Z2
- Ak je 1 záujemca: Z2_* polia nechaj prázdne ("") a 2. GDPR objekt VYNECHAJ

Pre výhradnú DOM (1 záujemca):
...
Pre výhradnú DOM (2 záujemcovia) — Z2 polia vyplnené + 2× GDPR:
READY_TO_GENERATE:{"contracts":[{"template":"dom","data":{"AS_MENO":"","AS_SIDLO":"","AS_ICO":"","AS_TEL":"","AS_EMAIL":"","Z1_MENO":"Meno Z1","Z1_ADRESA":"Adresa Z1","Z1_RC":"RC Z1","Z1_DATUM_NAR":"Dátum Z1","Z1_TEL":"Tel Z1","Z1_EMAIL":"Email Z1","Z2_MENO":"Meno Z2","Z2_ADRESA":"Adresa Z2","Z2_RC":"RC Z2","Z2_DATUM_NAR":"Dátum Z2","Z2_TEL":"Tel Z2","Z2_EMAIL":"Email Z2","POZEMOK_1":"- parcelné číslo: XXXX, výmera: XX m2, druh pozemku: zastavané plochy a nádvoria","POZEMOK_2":"- parcelné číslo: XXXX, výmera: XX m2, druh pozemku: ostatná plocha","STAVBA_1":"- druh stavby: rodinný dom, súpisné číslo: XXXX, postavená na parcele reg. C KN parc.č. XXXX","LV_CISLO":"","KU_NAZOV":"","OKRES":"","CENA":"","PROVIZNA":"3% vrátane DPH","PLATNOST_DO":""}},{"template":"gdpr","data":{"Z1_MENO":"Meno Z1","Z1_ADRESA":"Adresa Z1","Z1_DATUM_NAR":"Dátum Z1","Z1_TEL":"Tel Z1","Z1_EMAIL":"Email Z1"}},{"template":"gdpr","data":{"Z1_MENO":"Meno Z2","Z1_ADRESA":"Adresa Z2","Z1_DATUM_NAR":"Dátum Z2","Z1_TEL":"Tel Z2","Z1_EMAIL":"Email Z2"}}]}

Pre výhradnú BYT (1 záujemca):
...
DÔLEŽITÉ PRAVIDLÁ:
- GDPR vždy pre každého záujemcu — skutočné hodnoty, nie placeholdery
- 2 záujemcovia = Z2_* polia v zmluve vyplnené + 2. GDPR s údajmi Z2
- CENA vždy: "500.000,00 EUR (slovom: Päťstotisíc eur)"
- Pre nevýhradné: AS_DIC = DIČ, AS_OR = číslo vložky OR, AS_ZASTUPENA = meno konateľa
